      ...
      <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[550px]">
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription>Enter your information to create your account and start your free trial</CardDescription>
          </CardHeader>
                      ...
                      <FormControl>
                        ...
                        >
                          <FormItem className="flex flex-col items-center space-y-2 rounded-md border p-4 [&:has([data-state=checked])]:border-primary">
                            <FormControl>
                              <RadioGroupItem value="free-trial" className="sr-only" />
                            </FormControl>
                            <FormLabel className="font-normal cursor-pointer text-center">
                              <span className="block font-semibold">Free Trial</span>
                              <span className="block text-sm text-muted-foreground">30 days</span>
                              <span className="block font-semibold mt-1">$0</span>
                            </FormLabel>
                          </FormItem>
                          <FormItem className="flex flex-col items-center space-y-2 rounded-md border p-4 [&:has([data-state=checked])]:border-primary">
                            <FormControl>
                            ...
                            <FormLabel className="font-normal cursor-pointer text-center">
                              ...
                              <span className="block font-semibold mt-1">$27.50</span>
                            </FormLabel>
                          </FormItem>
                          <FormItem className="flex flex-col items-center space-y-2 rounded-md border p-4 [&:has([data-state=checked])]:border-primary">
                            <FormControl>
                            ...
                            <FormLabel className="font-normal cursor-pointer text-center">
                              ...
                              <span className="block text-sm text-muted-foreground">Save 20%</span>
                              <span className="block font-semibold mt-1">$264</span>
                            </FormLabel>
                          </FormItem>
                        </RadioGroup>
                      </FormControl>
