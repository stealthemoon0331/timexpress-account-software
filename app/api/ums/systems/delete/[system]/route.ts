...
import { deleteUserFromAMS, deleteUserFromCRM, deleteUserFromUSLM, deleteUserFromFMS, deleteUserFromQCMS, deleteUserFromTDMS, deleteUserFromTMS, deleteUserFromTSMS, deleteUserFromWMS, deleteUserFromHR, deleteUserFromCHATESS } from "@/lib/ums/systemHandlers/delete/handler";
  ...
  try {
    ...
    switch (system.toUpperCase()) {
      ...
      case "HR":
        ...
        break;
        case "USLM":
        result = await deleteUserFromUSLM({user});
        break;
      case "CHATESS":
        result = await deleteUserFromCHATESS({user});
        break;
      default:
