...
export async function updateUserInUSLM({
  formData,
  roleId,
  accessToken,
  user,
  ...
  // USLM update implementation
  try {

    if(!user.uslm_user_id) {
      throw new Error("Update field. Your data was not initialized");
    } 
    ...
    if (!response.ok) {
      ...
      return {
        isError: true,
        message: responseData.msg || `Failed to update user in USLM`,
        data: null,
      };
    }
    ...
    return {
      isError: false,
      message: "USLM user updated successfully",
      system: system,
      data: responseData.user,
    };
  } catch (error) {
    console.error("USLM update error:", error, " : ", typeof error);
...
export async function updateUserInCHATESS({
  formData,
  roleId,
  accessToken,
  user,
  ...
  try {
    ...
    return {
      isError: false,
      message: "CHATESS user updated successfully",
      system: system,
      data: responseData,
    };
  } catch (error) {
    console.error("CHATESS update error:", error, " : ", typeof error);
